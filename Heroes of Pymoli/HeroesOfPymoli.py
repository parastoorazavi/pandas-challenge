...
# ## Observable Trends
# 
# - Between 576 players, 84% male and 14% female, which means it is designed mainly for male. This large group of men assigned 1,967 Dollars, of total purchase value. As a result, we can understand this game isn’t a favorite female game so if the designers want to attract female, they should add more female characteristics in their game. 
# - (20-24) age group form 44% of total number of players and the total purchase value of these players is 1,114 Dollars. The second position is for (15-19) age group, that is 18% of the total portion. Considering the high difference between the number of players in (20-24) age group and the other groups, it can concluded that the game's design is more appealing to (20-24) age group.
# - “Final Critic “and “Oathbreaker, Last Hope of the Breaking Storm” are the most popular and profitable items among all 179 items. For future, developers and designers of this game could plan for adding similar items in this game to increase their profit.
